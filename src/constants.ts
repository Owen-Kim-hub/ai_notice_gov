...
export const PORTALS_LIST: PortalListItem[] = [
  ...
  { rank: 13, name: "범부처통합연구지원시스템 (IRIS, 접수예정)(추출 제외)", url: "https://www.iris.go.kr/contents/retrieveBsnsAncmBtinSituListView.do?ancmPrg=ancmPre" },
  { rank: 14, name: "한국보건산업진흥원 (KHIDI) (추출 제외)", url: "https://www.khidi.or.kr/board?menuId=MENU01108" },
  { rank: 15, name: "의료기기산업 종합정보시스템 (추출 제외)", url: "https://www.khidi.or.kr/board?menuId=MENU01484&siteId=SITE00039" },
  { rank: 16, name: "보건의료기술 종합정보시스템 (추출제외, 간헐적 불안정 사이트)", url: "https://www.htdream.kr/main/pubAmt/PubAmtList.do" }
];
