...
export const PORTALS_LIST: PortalListItem[] = [
  ...
  { rank: 2, name: "범부처통합연구지원시스템 (IRIS, 접수예정)", url: "https://www.iris.go.kr/contents/retrieveBsnsAncmBtinSituListView.do?ancmPrg=ancmPre" },
  { rank: 3, name: "국가과학기술지식정보서비스 (NTIS)", url: "https://www.ntis.go.kr/rndgate/eg/un/ra/mng.do" },
  { rank: 4, name: "한국산업기술기획평가원 (KEIT)", url: "https://srome.keit.re.kr/srome/biz/perform/opnnPrpsl/retrieveTaskAnncmListView.do?prgmId=XPG201040000" },
  { rank: 5, name: "한국산업기술진흥원 (KIAT)", url: "https://www.kiat.or.kr/front/board/boardContentsListPage.do?board_id=90" },
  ...
  { rank: 8, name: "산업통상자원부", url: "https://www.motir.go.kr/kor/article/ATCL2826a2625" },
  { rank: 9, name: "중소벤처기업부", url: "https://www.mss.go.kr/site/smba/ex/bbs/List.do?cbIdx=310" },
