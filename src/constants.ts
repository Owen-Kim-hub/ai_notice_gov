...
export const PORTALS_LIST: PortalListItem[] = [
  ...
  { rank: 12, name: "강원연구개발특구", url: "https://www.innopolis.or.kr/newBusiness?menuId=MENU01028" },
  { rank: 13, name: "강원지역산업진흥원", url: "https://www.riis.or.kr/html/pbanc/pbancList.do" },
  { rank: 14, name: "한국보건산업진흥원 (KHIDI) (공고추출 제외)", url: "https://www.khidi.or.kr/board?menuId=MENU01108" },
  { rank: 15, name: "의료기기산업 종합정보시스템 (공고추출 제외)", url: "https://www.khidi.or.kr/board?menuId=MENU01484&siteId=SITE00039" }
];
